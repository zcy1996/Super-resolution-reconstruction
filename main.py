...
flags.DEFINE_integer("inference_depth",1, "Number of recurrent CNN filters")
flags.DEFINE_integer("batch_num", 360, "Number of mini-batch images for training")
...
# Training or Others
flags.DEFINE_boolean("is_training",False, "Train model with 91 standard images")
flags.DEFINE_string("dataset", "76", "Test dataset. [76,yanzheng2，yanzheng1,ceshi90,yanzheng,set5, set14, bsd100, urban100, all, test] are available")
flags.DEFINE_string("training_set", "99", "Training dataset. [99，444,骨科91，222,guke190,guke1902,ScSR, Set5, Set14, Bsd100, Urban100] are available")
